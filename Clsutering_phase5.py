...
from scipy.cluster.hierarchy import ward, dendrogram,fcluster,maxdists
...
inputPath = "C:\\Users\divya\Dropbox\Study\IR\IRHW1\Inputfiles\\files2"
...
###############################################################################################################
dist=buildDF(wordListAll,list(docAndWords.keys()),stop_words=None, charset_error = 'replace')
linkage_matrix = ward(dist)
print('LinkageMatrix',linkage_matrix)

#print(linkage_matrix)
#A threshold of 0.4 is applied to clustering to make sure that clustering stops if the similarity between clusters is less than 0.4

fcluster(linkage_matrix, t=0.4, criterion='distance')
#print(maxdists(linkage_matrix))
#fcluster(linkage_matrix, criterion='maxclust')
ax = plt.subplots(figsize=(15, 20)) # set size
ax = dendrogram(linkage_matrix, above_threshold_color='#ffffff' ,orientation="right",labels=list(docAndWords.keys()),color_threshold=0.4)
...
#Dendrogram is saved in ward_clusters.png
